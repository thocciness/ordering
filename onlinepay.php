...
<html>
  ...
  <head>
    <title> Online Payment | The Resturant </title>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5 class="text-muted"> Card Number</h5>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 pad-adjust">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked class="text-muted" required=""> Save information for later. <a href="#">More Info</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="deliver.php"><input type="submit" class="btn btn-success btn-block" value="Pay" required="" /></a>  
                            </div>
                        </div>
