...
<div class="container">
    <div class="container">
        ...
        <a href="myrestaurant.php" class="list-group-item active">My Store</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> Add a store </button>    
      </div>
        </form>
