...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: teal;"><span class="glyphicon glyphicon-ok-circle"></span> Payment Success.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> Thank you for ordering at The Resturant</h2>
...
<h3 class="text-center"> <strong>Your order code:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3>
