...
<html>
  ...
  <head>
    <title> Guest Login | The Resturant </title>
  ...
  <body>
    ...
    <h1 style="font-size: 40px;">Welcome To </h1>
     <h1 style="font-size: 50px;"><span class="edit"> The Resturant </span></h1>
        <p style="font-size: 15px;"><i>Login to continue.</i></p>
      </div>
                  ...
                  <div class="panel-body">
                    <form action="" method="POST">
                      ...
                      <div style="text-align: center;">
                          <button style="t"class="btn btn-primary" name="submit" type="submit" value=" Login ">Confirm</button>
                          <br><br>
                          <label >or</label> <br>
