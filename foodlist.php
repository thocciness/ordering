...
<html>
  <head>
    <title> Explore | The Resturant </title>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/burgerology.jpg" style="width:100%;height: 68%;">
      <div class="carousel-caption">
      </div>
      </div>
    
      <div class="item">
      <img src="images/frenchfriescarl.jpg" style="width:100%;height: 68%;">
      <div class="carousel-caption">

      </div>
      </div>
      <div class="item">
      <img src="images/chocolatemuffin.jpg" style="width:100%;height: 68%;">
      <div class="carousel-caption">
      </div>
      </div>
...
<form style="position:relative;background-color: #ffc8a2;height: 500px;border-radius: 25px;padding: 10px;"method="post" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
...
<h5 style="text-align: center;color: #0000ff;" ><?php echo $row["description"]; ?></h5>
<h5 style="position: absolute;top: 69%;left: 42%; color: white;" >$<?php echo $row["price"]; ?></h5>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Sorry! No available food.</h1> </label>
        <p>Be patient!</p>
      </center>
