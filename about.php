...
<html>
  ...
  <head>
    <title> About | The Resturant </title>
...
?>
    ...
    <div class="wide">
        <div class="left">
           <iframe src="https://www.google.com/" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
        </div>
        <div class="right">
          <div class="tagline">What's <font color="red"><strong>Up</strong></font>Friends <font color="green"><strong><em>:)</em>.</strong></font></div>
          <h3 style="color: red">We love making food :)</h3>
          <h3 style="color: black;">Order your food and drinks here. <h3 style="color: black;">Hopefully you enjoy the food!</h3></h3>
        </div>
    </div>
 </body>
</html>