...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $tax = ($values["food_quantity"] * $values["food_price"]) * .065;
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <br>
<h1 class="text-center">Total Balance: $<?php echo number_format($gtotal,2); ?></h1>
<h5 class="text-center"><i>(Including Shipping)</i></h5>
<br>
<h1 class="text-center">
  <a href="cart.php"><button class="btn btn-warning"><span class="glyphicon glyphicon-circle-arrow-left"></span> Return to Cart</button></a>
  <a href="onlinepay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Online Payment</button></a>
  <a href="deliver.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Recieved Payment</button></a>
</h1>
